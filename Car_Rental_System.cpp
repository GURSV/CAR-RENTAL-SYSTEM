...
class rent : public customer // inhereted class from customer class
{
    ...
    if(carmodel=="A")
 {
    ...
    sleep(2); /* The sleep() function will sleep the present 
         executable for the time specified by the thread.
         Presumably, the CPU and other operations will 
         function normally. */
 }
  if(carmodel=="B")
  {
...
void showrent()
    ...
    cout <<"\n";
    cout << "\t\t	| Total Rental Amount is :"<<"-------|"<<setw(8)<<"Rs. "<<rentalfee<<"|"<<endl;
    cout << "\t\t	 ________________________________________________________"<<endl;
...
//[ PROGRAMMED BY: Gurmehar Singh(CO21318) & Ujjwal Chopra(CO21363) ]
